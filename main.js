function startClassification() {
    ...
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/pKhcCGAM0/model.json", modelReady);
}
function modelReady() {
...
function gotResults(error, results) {
    if (error) {
        ...
        if (results[0].label == "Love Nwantiti") {
            img.src = 'aliens-01.gif';
            img1.src = 'aliens-02.png';
            img2.src = 'aliens-03.png';
            img3.src = 'aliens-04.png';
        }
        else if (results[0].label == "Spotlight") {
